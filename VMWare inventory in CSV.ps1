...
$vcs = @("10.96.93.11") # FQDN of your vCenter server.
$logFile = "C:HYDVMInventory.csv" # Where you want to save the CSV file
$vcsCluster = "*" # Filters which cluster you want to pull VM stats from.
$businessUnitName = "HYD-LAB" # Name of Business Unit that the script is gathering stats for
